...
![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Hi+%F0%9F%91%8B+I'm+Pranay+Khojare;Java+Full+Stack+Developer;Spring+Boot+%7C+React+%7C+Azure+Cloud;Immediate+Joiner+%F0%9F%9A%80)

![Profile Views](https://komarev.com/ghpvc/?username=PRANAYKHOJARE&color=58A6FF&style=flat-square&label=Profile+Views)
...
```java
public class Pranay {
    String name        = "Pranay Khojare";
    String degree      = "B.E. Information Technology — SGBAU (CGPA 8.22)";
    String location    = "Pune, Maharashtra, India";
    String current     = "Intern @ PugArch Technology Pvt. Ltd.";
    String[] targets   = { "SDE-1", "Java Full Stack Developer", "Azure Cloud" };
    ...
    String passion = "Building deployable full-stack systems from scratch";
}
```
